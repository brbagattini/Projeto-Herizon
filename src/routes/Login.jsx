          ...
          <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 flex flex-col items-center">
            <div className="relative">
              <img
                ...
                alt="Avatar"
                className="w-36 h-36 sm:w-40 sm:h-40 rounded-full border-4 border-[var(--clr-bg)] object-cover shadow-xl"
              />
            ...
            <div className="text-center mt-6">
              ...
              <p className="text-[var(--clr-muted)] text-base">
        ...
        <div className="pt-24 sm:pt-28 px-10 sm:px-16 md:px-20 pb-12">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <label className="block text-sm text-[var(--clr-muted)] mb-1">
                  Nome completo
                </label>
                <input
                  name="name"
                  ...
                  className="w-full bg-[#141414] border border-[var(--clr-border)] text-white rounded-md px-4 py-2.5 focus:ring-2 focus:ring-[var(--clr-destaque)] outline-none"
                />
              </div>
              <div>
                <label className="block text-sm text-[var(--clr-muted)] mb-1">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <input
                  ...
                  value={form.birth}
                  onChange={onChange}
                  className="w-full bg-[#141414] border border-[var(--clr-border)] text-white rounded-md px-4 py-2.5"
                />
              </div>
              <div>
                <label className="block text-sm text-[var(--clr-muted)] mb-1">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-[#141414] border border-[var(--clr-border)] text-white rounded-md px-4 py-2.5 resize-none"
              />
            </div>
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                className="bg-[var(--clr-destaque)] text-black font-semibold px-8 py-3 rounded-lg hover:brightness-110 transition-all"
              >
                Salvar perfil
              </button>
            </div>
